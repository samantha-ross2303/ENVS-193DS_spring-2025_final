...
In both the 2016 and 2019 seasons, Swift Parrot nest box occupancy was higher near the forest edge and declined with increasing distance (Figure 1). In 2016, the predicted probability of occupancy was 0.48 at 0 m and dropped to 0.12 at 900 m. In 2019, occupancy was lower overall, with a probability of 0.30 at 0 m and 0.06 at 900 m. This pattern suggests that Swift Parrots prefer nest boxes closer to the forest edge. The lower occupancy in 2019 suggests increased competition from non-target species like Common Starlings and Tree Martins, which had more time to discover and dominate nest boxes left in place since 2016.
